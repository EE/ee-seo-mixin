...
class ModelMixinTestCase(TestCase):
    ...
    source: https://stackoverflow.com/questions/4281670/django-best-way-to-unit-test-an-abstract-model
    '''
    @classmethod
    def setUpClass(cls):
        # Create a dummy model which extends the mixin
        cls.model = ModelBase('__TestModel__' + cls.mixin.__name__, (cls.mixin,), {'__module__': cls.mixin.__module__})
